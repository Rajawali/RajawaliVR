...
public abstract class RajawaliSideBySideRenderer extends RajawaliRenderer {
	...
	public void initScene() {
		...
		mCameraLeft.setProjectionMatrix(mDefaultViewportWidth, mDefaultViewportHeight);
		mCameraRight.setProjectionMatrix(mDefaultViewportWidth, mDefaultViewportHeight);
